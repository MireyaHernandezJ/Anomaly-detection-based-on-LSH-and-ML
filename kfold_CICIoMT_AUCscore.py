...
def plot_roc_curve(labels_test,results_classifier,model,timewindow):
        ...
        plt.legend()
        plt.savefig(f'roc_curve_{timewindow}_CICIoMT.png')
...
classifier2 = DecisionTreeClassifier(random_state=0,max_depth=40)
classifier1 = LogisticRegression(random_state=0,max_iter=160)
classifier3 = RandomForestClassifier(random_state=0,max_depth=37,n_estimators=225)
classifier4 = AdaBoostClassifier(random_state=0,n_estimators=225)
model2='DT'
model1='LR'
model3='RF'
model4='Adaboost'
